      ...
      <div className="wishlist-page">
        <div className="wishlist-container">
          ...
          <div className="wishlist-empty">
            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#C48E82" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="wishlist-item-image">
                  {item.imageUrl ? (
                    ...
                    <div className="wishlist-item-image-placeholder">
                      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#C48E82" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
